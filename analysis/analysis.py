# analysis.py — Poverty Rates by Country (1995-2023): Global Longitudinal Dataset
...
keywords = ['poverty rates', 'global poverty', 'Gini coefficient', 'HDI', 'multidimensional poverty']
...
print(f"Dataset: Poverty Rates by Country (1995-2023): Global Longi")
print(f"DOI: 10.5281/zenodo.18984818")
...
fig.suptitle("Poverty Rates by Country (1995-2023): Global Longitudinal Da", fontsize=11, fontweight="bold")
...
print(f"""
Citation:
de la Serna Tuya, Juan Moisés (2026). Poverty Rates by Country (1995-2023): Global Longitudinal Dataset. Zenodo. https://doi.org/10.5281/zenodo.18984818
""")
